        ...
        appBar: AppBar(
          title: Text(
            editingId == null
                ...
                : AppStrings.get(context, 'editLog'),
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    AppStrings.get(context, 'enterContent'),
                                hintStyle:
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            tooltip: AppStrings.get(context, 'addCategory'),
                            onPressed: () =>
                ...
                Expanded(
                  child: ReorderableListView.builder(
                    ...
                    buildDefaultDragHandles:
                        false, // Explicitly disable standard small handles if we want custom
                    // Actually, for ReorderableDelayedDragStartListener to work, we disable default handles
                    // and ANY child can act as handle if wrapped.
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return CustomReorderableDelayedDragStartListener(
                        ...
                        index: index,
                        child: ListTile(
                          // Removed key from ListTile as it's on Listener
                          leading: Container(
                            width: 4,
                          ...
                          trailing: Row(
                            ...
                            children: [
                              ...
                              // Removed DragHandle Icon as user requested
                            ],
                          ),
                        ),
                      );
  ...
  void _showAddCategoryDialog(BuildContext context, LogProvider provider) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(AppStrings.get(context, 'addCategory')),
